...
export const CLIENTS: ClientType[] = [
  {
    ...
    "services": ["RWD","Content Strategy","Wordpress","Print"],
    "print": {
        "isPrinted": true,
        "printWork": [
            {
  ...
  },
  {
    ...
    "services": ["RWD","e-Commerce","Wordpress"],
    "print": {
      "isPrinted": false,
      "printWork": []
    }
  ...
  },
  {
    ...
    "services": ["RWD", "Static Html","Print"],
    "print": {
      "isPrinted": true,
      "printWork": [
        {
  ...
  },
  {
    ...
    "services": ["RWD", "Static Html", "Online Portfolio"],
    "print": {
      "isPrinted": false,
      "printWork": []
    }
